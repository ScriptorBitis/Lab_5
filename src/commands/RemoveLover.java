...
public class RemoveLover extends Command implements Executable {
    public RemoveLover(int wordsCount, CollectionManager collectionManager) {
        super(wordsCount, collectionManager);
    }

    public RemoveLover(int wordsCount) {
        super(wordsCount);
    }

    public RemoveLover(CollectionManager collectionManager) {
